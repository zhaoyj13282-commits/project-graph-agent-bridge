...
- [x] Windows x64 end-user scope confirmed; other platforms clearly bounded.
- [x] Independent official companion built with production assets and a separate identifier.
- [x] Public fixture created from a new empty project through official GUI/CLI.
